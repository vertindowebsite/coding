...
$SQL ="INSERT INTO Gojasa2 (nama,alamat,nomorhandphone,provinsi,kategori,harga,deskripsi)
VALUES ('$nama','$alamat','$nomorhandphone','$provinsi','$kategori','$harga','$deskripsi')";

mysql_query($SQL, $koneksi)
or die ("Data Gagal disimpan : ".mysql_error());
}
?>
Terima kasih sudah bergabung bersama Gojasa, aplikasi penyedia jasa terlengkap di Indonesia				
			<!--Edit Footer here-->
